...
const initArticle = async () => {
    ...
    if (contentContainer && articleData) {
        contentContainer.innerHTML = `
            ...
            ${articleData.image ? `<img src="${articleData.image.startsWith('http') ? articleData.image : (articleData.image.startsWith('/') ? articleData.image : '/' + articleData.image)}" alt="${articleData.title}" class="main-img">` : ''}
